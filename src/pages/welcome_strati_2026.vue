<template>
  <div class="container page-content">
    <h1>Welcome to STRATI 2026 in China: A New Chapter in Global Stratigraphy</h1>
    <p>
      We are excited to invite the global stratigraphy community to
      <b
        ><i
          >STRATI 2026 – Exploring the Depths: Bridging Tradition and Innovation in Stratigraphy</i
        ></b
    ...
    <p>
      Suzhou, a city renowned for its harmonious blend of heritage and modernity, provides an ideal backdrop for this global dialogue. The Suzhou DDE Center embodies the spirit of international scientific collaboration. As a hub for open-data initiatives and interdisciplinary cooperation, it will serve as a dynamic venue for showcasing global innovations in stratigraphy and facilitating hands-on engagement with cutting-edge tools.
    </p>
    <p>
    ...
    <div class="text-end">
      <p>
        Shuzhong Shen, Maoyan Zhu, Zhong-Qiang Chen<br /> Chairs of STRATI 2026
      </p>
    </div>
  </div>
</template>
