                ...
                <div class="position-relative">
                  ...
                  >
                    <option disabled="" value="">
                      Please select an appropriate theme.
                    </option>
                    <option>Theoretical and Systematics Mineralogy</option>
                    <option>Mineral Evolution</option>
                    <option>Environmental Mineralogy</option>
                    <option>Critical Mineralogy</option>
                    <option>Carbon Neutral Mineralogy</option>
                    <option>
                      'Deep' Mineralogy (Extraterrestrial Mineralogy, Planetary
                      interiors)
                    </option>
...
export default {
  ...
  methods: {
    ...
    submitProposal() {
      ...
      if (!this.checkEmpty("Theme", sd.theme)) {
        return;
      }
